...
test.describe('Auth Pages Snackbar Notifications', () => {
  ...
  test('Login page shows snackbar on authentication error', async ({ page }) => {
    await page.goto('/login');
  ...
  test('Register page shows snackbar on validation errors', async ({ page }) => {
  ...
  test('Forgot password page shows snackbar on validation error', async ({ page }) => {
  ...
  test('Reset password page shows snackbar on validation errors', async ({ page }) => {
  ...
  test('Reset password page shows snackbar on missing token', async ({ page }) => {
  ...
  test('Onboarding page shows snackbar on validation errors', async ({ page }) => {
