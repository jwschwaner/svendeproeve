...
test.describe("Account Settings Snackbar Notifications", () => {
  ...
  test("Profile section shows snackbar on validation error", async ({
    page,
  }) => {
  ...
  test("Profile section shows snackbar on successful update", async ({
    page,
  }) => {
    const fullNameInput = page.locator('input[type="text"]').nth(1);
  ...
  test("Password section shows snackbar on validation errors", async ({
    page,
  }) => {
  ...
  test("Delete Account section shows snackbar on confirmation error", async ({
    page,
  }) => {
