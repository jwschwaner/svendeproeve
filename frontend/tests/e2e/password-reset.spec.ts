...
test.describe("Forgot Password", () => {
  ...
  test("shows snackbar success message for non-existent email", async ({
    page,
  }) => {
    await page.goto("/forgot-password");
    await page
  ...
  test("shows snackbar success message for a registered email", async ({
    page,
    request,
  }) => {
...
test.describe("Reset Password", () => {
  test("shows snackbar error when token is missing from URL", async ({
    page,
  }) => {
  ...
  test("form fields are cleared after password fields are empty on submit", async ({
    page,
  }) => {
    await page.goto("/reset-password?token=sometoken");
    await page.getByTestId("reset-password-submit-button").click();
    ...
    await expect(
      page.getByTestId("reset-password-new-password-input"),
    ).toHaveValue("");
    await expect(
      page.getByTestId("reset-password-confirm-password-input"),
    ).toHaveValue("");
  });
